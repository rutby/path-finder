...
// 		private static _mapSize: cc.Size = null;
// 		private static _gridSize: cc.Size = null;

// 		//================================================ public
// 		public static initialize(mapSize: cc.Size, gridSize: cc.Size) {
...
// 		//================================================ utils
// 		/** UI坐标转换成格子坐标 */
// 		public static convertViewPosToMapPos(viewPos: IPos): cc.Vec2 {
// 			return cc.v2(Math.floor(viewPos.x / this._gridSize.width), Math.floor(viewPos.y / this._gridSize.height))
// 		}
			
// 		/** 格子坐标转换成UI坐标 */
// 		public static convertMapPosToViewPos(mapPos: IPos): cc.Vec2 {
